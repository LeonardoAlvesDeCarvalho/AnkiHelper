(function () {
    ...
    function hashCode(str) {
        ...
        return Math.abs(hash).toString(); // Garante que a chave será positiva
    }


    document.head.appendChild(style);
    const currentPageKey = hashCode(location.hostname + location.pathname);
    const defaultPageStorageKey = `ankiDefaultPage_${currentPageKey}`;
    const pageStorageKey = `ankiCustomizedPage_${currentPageKey}`;
